...
- `POST /api/v1/panchangam/range` — main version; body `{"start": "YYYY-MM-DD", "end": "YYYY-MM-DD"}`; returns the compact Panchangam for every day in the inclusive date range (capped at 366 days)
