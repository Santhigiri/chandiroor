...
from utils.cache.cache_navapoojitham import get_matching_dates
from utils.cache.cache_utils import PanchangamCache, remove_events_from_cache
...
def update_common_events(cache: PanchangamCache) -> PanchangamCache:
    ...
    for event in _COMMON_EVENTS:
        ...
        for dt, _ in matching_dates:
            cache[dt].santhigiri_significant_dates.append(event)
            modified_dates.add(dt)
